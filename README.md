...
[![CI](https://img.shields.io/github/actions/workflow/status/maidamai0/stdui/ci.yml?branch=codex/project-management&label=CI)](https://github.com/maidamai0/stdui/actions/workflows/ci.yml)
[![Coverage](https://img.shields.io/github/actions/workflow/status/maidamai0/stdui/coverage.yml?branch=codex/project-management&label=coverage)](https://github.com/maidamai0/stdui/actions/workflows/coverage.yml)
