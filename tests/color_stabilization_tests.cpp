...
TEST_CASE("color: exposes channels and standard values") {
  ...
  CHECK(stdui::color::red() == stdui::color{1.0f, 0.0f, 0.0f, 1.0f});
  CHECK(stdui::color::green() == stdui::color{0.0f, 1.0f, 0.0f, 1.0f});
  CHECK(stdui::color::blue() == stdui::color{0.0f, 0.0f, 1.0f, 1.0f});
